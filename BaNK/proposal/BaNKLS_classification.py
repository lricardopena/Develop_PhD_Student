...
class bank_classification(bank):
    ...
    def learn_kernel(self, number_swaps):
        for i in range(number_swaps):
            bank.sampling_Z(self)
            bank.sampling_mu_sigma_omega(self)
            self.__sample_omega()
    ...
    def predict_new_X(self, X, omegas=None, a0=0.001, b0=0.001, alpha_prior=0.000001, miu0 = None):
        ...
        Phi_x = bank.matrix_phi_with_X(self, self.X, self.frequences)
        ...
        Phi_x = bank.matrix_phi_with_X(self, X, self.frequences)
